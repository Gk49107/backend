export function genPaginationfromPackage(params: any) {
...
export function genFilterFromPackage(filterFields: string[], params: any): any {
  let payload: any = {};
...
export function filterPagination(filterFields, requestData) {
  let payload: any = {
    ...genFilterFromPackage(filterFields, requestData),
  };

  let paginationQuery: any = genPaginationfromPackage(requestData);
